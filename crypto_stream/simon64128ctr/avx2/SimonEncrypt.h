...
#define Ex40(X,Y,k) (Rx40(X,Y,k[0],k[1]),   Rx40(X,Y,k[2],k[3]),   Rx40(X,Y,k[4],k[5]),   Rx40(X,Y,k[6],k[7]),   Rx40(X,Y,k[8],k[9]), \
		     ...
		     Rx40(X,Y,k[40],k[41]), Rx40(X,Y,k[42],k[43]))
...
#define Ex32(X,Y,k) (Rx32(X,Y,k[0],k[1]),   Rx32(X,Y,k[2],k[3]),   Rx32(X,Y,k[4],k[5]),   Rx32(X,Y,k[6],k[7]),   Rx32(X,Y,k[8],k[9]), \
                     ...
                     Rx32(X,Y,k[40],k[41]), Rx32(X,Y,k[42],k[43]))
...
#define Ex24(X,Y,k) (Rx24(X,Y,k[0],k[1]),   Rx24(X,Y,k[2],k[3]),   Rx24(X,Y,k[4],k[5]),   Rx24(X,Y,k[6],k[7]),   Rx24(X,Y,k[8],k[9]), \
                     ...
                     Rx24(X,Y,k[40],k[41]), Rx24(X,Y,k[42],k[43]))
...
#define RK(c0,c1,c2,c3,A,B,C,D,rk,key,i) (T=RCS(D,3)^B, A^=c0^T^RCS(T,1), key[i]=A,   rk[i]=SET(A,A,A,A,A,A,A,A), \
					  T=RCS(A,3)^C, B^=c1^T^RCS(T,1), key[i+1]=B, rk[i+1]=SET(B,B,B,B,B,B,B,B), \
					  T=RCS(B,3)^D, C^=c2^T^RCS(T,1), key[i+2]=C, rk[i+2]=SET(C,C,C,C,C,C,C,C), \
					  T=RCS(C,3)^A, D^=c3^T^RCS(T,1), key[i+3]=D, rk[i+3]=SET(D,D,D,D,D,D,D,D))
