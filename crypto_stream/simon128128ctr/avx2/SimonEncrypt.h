...
#define Ex20(X,Y,k) (Rx20(X,Y,k[0],k[1]),   Rx20(X,Y,k[2],k[3]),   Rx20(X,Y,k[4],k[5]),   Rx20(X,Y,k[6],k[7]),   Rx20(X,Y,k[8],k[9]), \
		     ...
		     Rx20(X,Y,k[60],k[61]), Rx20(X,Y,k[62],k[63]), Rx20(X,Y,k[64],k[65]), Rx20(X,Y,k[66],k[67]))
...
#define Ex16(X,Y,k) (Rx16(X,Y,k[0],k[1]),   Rx16(X,Y,k[2],k[3]),   Rx16(X,Y,k[4],k[5]),   Rx16(X,Y,k[6],k[7]),   Rx16(X,Y,k[8],k[9]), \
                     ...
                     Rx16(X,Y,k[60],k[61]), Rx16(X,Y,k[62],k[63]), Rx16(X,Y,k[64],k[65]), Rx16(X,Y,k[66],k[67]))
...
#define Ex12(X,Y,k) (Rx12(X,Y,k[0],k[1]),   Rx12(X,Y,k[2],k[3]),   Rx12(X,Y,k[4],k[5]),   Rx12(X,Y,k[6],k[7]),   Rx12(X,Y,k[8],k[9]), \
                     ...
                     Rx12(X,Y,k[60],k[61]), Rx12(X,Y,k[62],k[63]), Rx12(X,Y,k[64],k[65]), Rx12(X,Y,k[66],k[67]))
...
#define Ex8(X,Y,k) (Rx8(X,Y,k[0],k[1]),   Rx8(X,Y,k[2],k[3]),   Rx8(X,Y,k[4],k[5]),   Rx8(X,Y,k[6],k[7]),   Rx8(X,Y,k[8],k[9]),\
		    ...
		    Rx8(X,Y,k[60],k[61]), Rx8(X,Y,k[62],k[63]), Rx8(X,Y,k[64],k[65]), Rx8(X,Y,k[66],k[67]))
...
#define Ex4(X,Y,k) (Rx4(X,Y,k[0],k[1]),   Rx4(X,Y,k[2],k[3]),   Rx4(X,Y,k[4],k[5]),   Rx4(X,Y,k[6],k[7]),   Rx4(X,Y,k[8],k[9]),	\
		    ...
		    Rx4(X,Y,k[60],k[61]), Rx4(X,Y,k[62],k[63]), Rx4(X,Y,k[64],k[65]), Rx4(X,Y,k[66],k[67]))
...
#define Ex2(X,Y,k) (Rx2(X,Y,k[0],k[1]),   Rx2(X,Y,k[2],k[3]),   Rx2(X,Y,k[4],k[5]),   Rx2(X,Y,k[6],k[7]),   Rx2(X,Y,k[8],k[9]),	\
		    ...
		    Rx2(X,Y,k[60],k[61]), Rx2(X,Y,k[62],k[63]), Rx2(X,Y,k[64],k[65]), Rx2(X,Y,k[66],k[67]))
...
#define Ex1(X,Y,k) (Rx1(X,Y,k[0],k[1]),   Rx1(X,Y,k[2],k[3]),   Rx1(X,Y,k[4],k[5]),   Rx1(X,Y,k[6],k[7]),   Rx1(X,Y,k[8],k[9]),	\
		    ...
		    Rx1(X,Y,k[60],k[61]), Rx1(X,Y,k[62],k[63]), Rx1(X,Y,k[64],k[65]), Rx1(X,Y,k[66],k[67]))
...
#define RK(c0,c1,A,B,rk,key,i) (A^=c0^(RCS(B,3)^RCS(B,4)), key[i]=A, rk[i]=SET(A,A,A,A), B^=c1^(RCS(A,3)^RCS(A,4)), key[i+1]=B, rk[i+1]=SET(B,B,B,B))

#define EK(A,B,rk,key) (RK(_d,_c,A,B,rk,key,2),  RK(_d,_c,A,B,rk,key,4),  RK(_d,_d,A,B,rk,key,6),  RK(_d,_d,A,B,rk,key,8), \
